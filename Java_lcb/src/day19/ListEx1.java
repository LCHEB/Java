...
public class ListEx1 {
	...
	public static void main(String[] args) {
		...
		/* list3는 List인터페이스를 구현한 구현 클래스들의 객체중 아무나 올수 있다.
		 ...
		 * - 해당 클래스의 equals가 어떻게 오버라이딩 되어 있는냐에 따라 결과가 달라짐
		 */
		 ...
		 *  - 정렬 기준은 정수로 알려주고, 음수이면 앞, 0이면 같은위치, 양수이면 뒤
