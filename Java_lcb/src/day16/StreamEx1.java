...
public class StreamEx1 {
	...
	public static void main(String[] args) {
		...
		stream = list.stream();//한번 쓴 스트림은 다시 한번 선언
		...
		//위에서 작성한 filter 예제를 복붙후 stream 대신 stream2로 수정
		//리스트로 만든 스트림과 배열로 ㅁ나든 스트림을 같은 방법을 이용하여 사용할 수 있다.
