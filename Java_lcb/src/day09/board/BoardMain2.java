...
public class BoardMain2 {
	 ...
	 * 
	 * 게시글 목록
	 * 	 2. 가입인사 2023-12-20 asd(아이디) 1(조회수)
	 ...
	 *   
	 * 게시글 목록
	 * 	 2. 가입인사입니다. 2023-12-20 asd(아이디) 2(조회수)
	 *   1. 공지 2023-12-19 admin 3
	 * 메뉴
	 *   1. 게시글 상세 조회
	 *   2. 게시글 수정
	...
	/**수정할 게시글 번호와 재목, 내용을 입력받아 게시글을 수정하는 메서드
	 * 
	 */
	 ...
	 * 
	 */
	private static void intsertBoard() {
		...
		Board board = new Board(boardNum++/*추가될 게시글 번호를 1증가*/, title, contents, writer, date);
