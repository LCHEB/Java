	...
	<c:choose>
		<c:when test="${board != null}">
			...
			<div class="mb-3 mt-3">
				...
				<input type="text" class="form-control" name="title" readonly value="${board.bo_title}">
			</div>
			<div class="mb-3 mt-3">
				<label for="writer" class="form-label">작성자</label>
				<input type="text" class="form-control" name="writer" readonly value="${board.bo_me_id}">
			</div>
			<div class="mb-3 mt-3">
